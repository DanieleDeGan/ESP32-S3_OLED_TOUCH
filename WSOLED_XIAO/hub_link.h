...
// =====================================================================
//  hub_link — il nodo camera visto dall'hub del camper (ESP-NOW)
//
//  Sottile strato sopra WSOLED_Link (libreria condivisa in libraries/):
...
//  peer con WSOLED_LINK_CHANNEL_CURRENT e non forza nulla, restando sul
...
//  WSOLED_LINK_CHANNEL: in quel caso l'hub standard va bene com'e'.
// =====================================================================
