...
// =====================================================================
//  net_ota — WiFi + OTA (boilerplate isolato, gemello di C3_OLED_OTA)
//
//  Porta su:
...
//
//  A differenza della versione C3, qui la rotta "/" NON e' registrata: la
//  home e' la web UI della camera (web_ui.cpp), che si aggancia allo stesso
//  WebServer tramite net_server(). Di norma questo file non si tocca.
// =====================================================================
