 ...
 * WSOLED_Link.h
 *
 * Livello di comunicazione ESP-NOW generico per il sistema di controllo
 * camper: questa board fa da "hub" (ruolo LINK_NODE_HUB) e riceve dati da
 * moduli sensore/attuatore indipendenti ("nodi", altri tipi di
 * link_node_type_t) via radio, senza bisogno di router/broker.
 *
...
#ifndef WSOLED_LINK_H
#define WSOLED_LINK_H
 ...
 * WSOLED_Link lo espone solo nel callback di scoperta di un peer sconosciuto
...
/**
 * Inizializza WiFi in modalita' STA sul canale fisso WSOLED_LINK_CHANNEL e
