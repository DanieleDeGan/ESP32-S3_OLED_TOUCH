 ...
 *     fra pannello e card, riscrivendo anche WSOLED_Display. NON supportata qui.
 ...
 * millisecondo in piu' ma se salta l'alimentazione - su un camper succede -
 * si perde al massimo l'ultima riga, non l'intero file.
 */
